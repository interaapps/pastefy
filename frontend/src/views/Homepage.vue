<template>
    <div>
        <div v-if="$store.state.user.logged_in">
            ...
            <h2>
                Your pastes & folders. <router-link to="/shared" v-if="$store.state.user.auth_type == 'interaapps'">Shared pastes</router-link>
                <template v-if="$store.state.user.type == 'ADMIN'">, <router-link to="/admin">Admin-Panel</router-link></template>
            </h2>
            <div id="folders">
                <a class="button" style="float: right; padding: 4px 16px"
                   @click="addFolderInput = !addFolderInput">NEW</a>
                ...
                <div v-if="addFolderInput" style="margin-bottom: 20px">
                    ...
                    <a class="button"
                       style="width: 49%; margin-right: 1%; background: var(--obj-background-color-hover)"
            ...
            <div id="pastes">
                <a class="button" @click="$store.state.currentPaste.folder = null; $store.state.app.fullscreen = true"
                   style="float: right; padding: 4px 16px">NEW</a>
        ...
        <div v-else>
            ...
            <div id="pastes">
                <router-link v-for="paste of $store.state.app.lastPastes" :to="'/'+paste.id" :key="paste.id"
                             class="paste">
