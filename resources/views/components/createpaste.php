...
<!--
	...
	<a id="<?php echo ($cp_id); ?>_open_optional_paste_options" style="cursor: pointer; color: #FFFFFF;">Optional Options</a><br><br>
		<div id="<?php echo ($cp_id); ?>_optional_paste_options">
			...
			<?php if( (\app\classes\User::usingIaAuth()) ? \app\classes\User::loggedIn() : false ):?>
				<a id="<?php echo ($cp_id); ?>_folderLoadingIndicator"></a>
				<br>
				<br>Folder:<br><br> <select id="<?php echo ($cp_id); ?>_folderList" name="folder">
					<option value="">/</option>
				</select>
			<?php endif; ?>
		</div>
	...
	<a class="clear" id="<?php echo ($cp_id); ?>_clear">Clear</a>
</form>
